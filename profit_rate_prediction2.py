...
if __name__ == '__main__':    
    ...
    for attribute in pop_final.columns.difference(['profit_rate',u'sku价格']):
        le = preprocessing.LabelEncoder()
        pop_final[attribute] = le.fit_transform(pop_final[attribute])
    ...
    pop_predictions = rfr.predict(pop_final)
